    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className = " logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTB03lSsH2qsXxwWDrXUBUk1ZQ9yQp0NMJGS7jV2XMZdQ&s"/>
...
const RestarentContainer = (props)=>{
    const { resData } = props;
...
const BodyComponets = () =>{
    return (
        <div className="body">
          ...
          <RestarentContainer key={restaurant.data.id} resData={restaurant} />
        ))}
            </div>
